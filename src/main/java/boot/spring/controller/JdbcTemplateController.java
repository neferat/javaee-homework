...
public class JdbcTemplateController {
	...
	public AjaxResult actor(){
		...
		return AjaxResult.success("update success, affect " + number + "rows");
	}	


	@RequestMapping(value="/actors/jdbc/insert",method = RequestMethod.GET)
	@ResponseBody
	public AjaxResult actorinsert(){
		...
		return AjaxResult.success("insert success, affect " + affact + " rows");
	}	
	...
	public AjaxResult delete(){
		...
		return AjaxResult.success("delete success, affect " + affact + " rows");
	}	
}
